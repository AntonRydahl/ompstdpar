...
# %bb.1:                                # %invoke.cont
	...
	testl	%eax, %eax
	je	.LBB0_3
# %bb.2:                                # %omp_offload.failed.i.i.i.i
	leaq	.L__unnamed_1(%rip), %rdi
...
.LBB0_5:                                # %for.body
	...
	testl	%eax, %eax
	je	.LBB0_7
# %bb.6:                                # %omp_offload.failed.i.i.i.i29
...
.LBB0_8:                                # %if.then.i.i.i.i
	...
	testl	%eax, %eax
	je	.LBB0_12
.LBB0_11:                               # %return.sink.split.i.i.i.i
                                        #   in Loop: Header=BB0_5 Depth=1
	movq	%rbx, (%rsp)
	movl	$35791394, %ecx                 # imm = 0x2222222
	movq	%r13, %rdi
...
# %bb.4:                                # %for.cond
	...
	cmpl	$99, %eax
	jl	.LBB0_5
# %bb.16:                               # %_ZNSt3__16vectorIiNS_9allocatorIiEEED2B7v180000Ev.exit17
	movq	%r14, %rdi
	callq	_ZdlPv@PLT
	movq	%rbx, %rdi
	callq	_ZdlPv@PLT
...
.LBB0_14:                               # %cond.false43
	leaq	.L.str.2(%rip), %rdi
	leaq	.L.str.1(%rip), %rsi
	leaq	.L__PRETTY_FUNCTION__.main(%rip), %rcx
	movl	$18, %edx
	callq	__assert_fail@PLT
.LBB0_15:                               # %_ZNSt3__128__exception_guard_exceptionsINS_6vectorIiNS_9allocatorIiEEE16__destroy_vectorEED2B7v180000Ev.exit.i9
.Ltmp2:
	movq	%rax, %r14
	movq	%rbx, %rdi
	callq	_ZdlPv@PLT
...
.L.str.1:
	.asciz	"src/transform_reduce/std_vector.cpp"
	.size	.L.str.1, 36
...
.omp_offloading.entry_name.12:
	...
	.size	.omp_offloading.entry_name.12, 142
...
.omp_offloading.entry_name.14:
	...
	.size	.omp_offloading.entry_name.14, 149
