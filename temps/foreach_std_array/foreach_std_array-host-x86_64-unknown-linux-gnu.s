...
# %bb.0:                                # %entry
	...
	subq	$320000216, %rsp                # imm = 0x1312D0D8
	.cfi_def_cfa_offset 320000272
	.cfi_offset %rbx, -56
	.cfi_offset %r12, -48
	.cfi_offset %r13, -40
	.cfi_offset %r14, -32
...
.LBB0_4:                                # %for.body
	...
	testl	%eax, %eax
	je	.LBB0_6
# %bb.5:                                # %omp_offload.failed.i.i.i.i.i.i.i.i18
...
# %bb.9:                                # %for.cond.cleanup
	xorl	%eax, %eax
	addq	$320000216, %rsp                # imm = 0x1312D0D8
	.cfi_def_cfa_offset 56
	popq	%rbx
	.cfi_def_cfa_offset 48
	popq	%r12
...
.L.str.1:
	.asciz	"src/foreach_std_array.cpp"
	.size	.L.str.1, 26
