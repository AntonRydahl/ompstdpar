; ModuleID = 'temps/benchmarks/dot/dot-openmp-amdgcn-amd-amdhsa-gfx906.tmp.bc'
...
@__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_kernel_environment = weak_odr protected addrspace(1) constant %struct.KernelEnvironmentTy.19 { %struct.ConfigurationEnvironmentTy.18 { i8 0, i8 1, i8 2 }, ptr addrspacecast (ptr addrspace(1) @1 to ptr), ptr addrspacecast (ptr addrspace(1) @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_dynamic_environment to ptr) }
...
entry:
  ...
  store ptr %__value, ptr %__value.addr.ascast, align 8, !tbaa !16
  %0 = load ptr, ptr %__value.addr.ascast, align 8, !tbaa !16
...
user_code.entry:                                  ; preds = %entry
  ...
  %6 = load ptr, ptr %tmp.ascast, align 8, !tbaa !16
...
omp.inner.for.cond:                               ; preds = %cond.end13, %cond.end
  ...
  %13 = load i64, ptr %.capture_expr.2.ascast, align 8, !tbaa !12, !llvm.access.group !20
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  store ptr %19, ptr %27, align 8, !tbaa !16, !llvm.access.group !20
  %28 = load ptr, ptr %.global_tid..addr.ascast, align 8, !llvm.access.group !20
  %29 = load i32, ptr %28, align 4, !tbaa !18, !llvm.access.group !20
...
omp.inner.for.inc:                                ; preds = %omp.inner.for.body
  %30 = load i64, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %31 = load i64, ptr %.omp.stride.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %add7 = add nsw i64 %30, %31
  store i64 %add7, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %32 = load i64, ptr %.omp.comb.lb.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %33 = load i64, ptr %.omp.stride.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %add8 = add nsw i64 %32, %33
  store i64 %add8, ptr %.omp.comb.lb.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %34 = load i64, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %35 = load i64, ptr %.omp.stride.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %add9 = add nsw i64 %34, %35
  store i64 %add9, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %36 = load i64, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %37 = load i64, ptr %.capture_expr.2.ascast, align 8, !tbaa !12, !llvm.access.group !20
  %cmp10 = icmp sgt i64 %36, %37
  br i1 %cmp10, label %cond.true11, label %cond.false12

cond.true11:                                      ; preds = %omp.inner.for.inc
  %38 = load i64, ptr %.capture_expr.2.ascast, align 8, !tbaa !12, !llvm.access.group !20
  br label %cond.end13
...
cond.end13:                                       ; preds = %cond.false12, %cond.true11
  ...
  %40 = load i64, ptr %.omp.comb.lb.ascast, align 8, !tbaa !12, !llvm.access.group !20
  store i64 %40, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !20
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %43 = load i32, ptr %.omp.is_last.ascast, align 4, !tbaa !18
  %44 = icmp ne i32 %43, 0
  br i1 %44, label %.omp.final.then, label %.omp.final.done

.omp.final.then:                                  ; preds = %omp.loop.exit
  %45 = load i64, ptr %.capture_expr..ascast, align 8, !tbaa !12
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %13 = load ptr, ptr %tmp.ascast, align 8, !tbaa !16, !llvm.access.group !24
  %14 = load float, ptr %13, align 4, !tbaa !25, !llvm.access.group !24
  %15 = load ptr, ptr %__first.addr.ascast, align 8, !tbaa !16, !llvm.access.group !24
  %16 = load i64, ptr %__i4.ascast, align 8, !tbaa !12, !llvm.access.group !24
  %arrayidx = getelementptr inbounds float, ptr %15, i64 %16
  store float %14, ptr %arrayidx, align 4, !tbaa !25, !llvm.access.group !24
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %17 = load i64, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !24
  %18 = load i64, ptr %.omp.stride.ascast, align 8, !tbaa !12, !llvm.access.group !24
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %21 = load i32, ptr %.omp.is_last.ascast, align 4, !tbaa !18
  %22 = icmp ne i32 %21, 0
  br i1 %22, label %.omp.final.then, label %.omp.final.done

.omp.final.then:                                  ; preds = %omp.loop.exit
  %23 = load i64, ptr %.capture_expr..ascast, align 8, !tbaa !12
...
entry:
  ...
  %3 = call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_kernel_environment to ptr))
...
user_code.entry:                                  ; preds = %entry
  ...
  store i64 %5, ptr %__n.casted.ascast, align 8, !tbaa !12
  %6 = load i64, ptr %__n.casted.ascast, align 8, !tbaa !12
  %7 = load ptr, ptr %__first1.addr.ascast, align 8, !tbaa !16
  %8 = load ptr, ptr %__first2.addr.ascast, align 8, !tbaa !16
  store i32 0, ptr %.zero.addr.ascast, align 4
  store i32 %4, ptr %.threadid_temp..ascast, align 4, !tbaa !18
  call void @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_omp_outlined(ptr %.threadid_temp..ascast, ptr %.zero.addr.ascast, i64 %6, ptr %0, ptr %1, ptr %2, ptr %7, ptr %8) #3
  call void @__kmpc_target_deinit()
  ret void
...
; Function Attrs: alwaysinline convergent norecurse nounwind
define internal void @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %__n, ptr noundef nonnull align 4 dereferenceable(4) %__init, ptr noundef nonnull align 1 dereferenceable(1) %__reduce, ptr noundef nonnull align 1 dereferenceable(1) %__transform, ptr noundef %__first1, ptr noundef %__first2) #1 {
entry:
  %.global_tid..addr = alloca ptr, align 8, addrspace(5)
  %.bound_tid..addr = alloca ptr, align 8, addrspace(5)
  %__n.addr = alloca i64, align 8, addrspace(5)
  ...
  store float 0.000000e+00, ptr %__init1.ascast, align 4, !tbaa !25
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %.omp.iv) #3
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %.capture_expr.) #3
  %3 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !12
  store i64 %3, ptr %.capture_expr..ascast, align 8, !tbaa !12
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %.capture_expr.2) #3
  %4 = load i64, ptr %.capture_expr..ascast, align 8, !tbaa !12
  %sub = sub nsw i64 %4, 0
  %div = sdiv i64 %sub, 1
  %sub3 = sub nsw i64 %div, 1
  store i64 %sub3, ptr %.capture_expr.2.ascast, align 8, !tbaa !12
...
omp.precond.then:                                 ; preds = %entry
  ...
  store i64 0, ptr %.omp.comb.lb.ascast, align 8, !tbaa !12
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %.omp.comb.ub) #3
  %6 = load i64, ptr %.capture_expr.2.ascast, align 8, !tbaa !12
  store i64 %6, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %.omp.stride) #3
  store i64 1, ptr %.omp.stride.ascast, align 8, !tbaa !12
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %.omp.is_last) #3
  store i32 0, ptr %.omp.is_last.ascast, align 4, !tbaa !18
  ...
  %9 = load i64, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12
  %10 = load i64, ptr %.capture_expr.2.ascast, align 8, !tbaa !12
...
cond.false:                                       ; preds = %omp.precond.then
  %12 = load i64, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %11, %cond.true ], [ %12, %cond.false ]
  store i64 %cond, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12
  %13 = load i64, ptr %.omp.comb.lb.ascast, align 8, !tbaa !12
  store i64 %13, ptr %.omp.iv.ascast, align 8, !tbaa !12
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %cond.end14, %cond.end
  %14 = load i64, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %15 = load i64, ptr %.capture_expr.2.ascast, align 8, !tbaa !12, !llvm.access.group !29
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %16 = load i64, ptr %.omp.comb.lb.ascast, align 8, !llvm.access.group !29
  %17 = load i64, ptr %.omp.comb.ub.ascast, align 8, !llvm.access.group !29
  %18 = load i64, ptr %__n.addr.ascast, align 8, !tbaa !12, !llvm.access.group !29
  store i64 %18, ptr %__n.casted.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %19 = load i64, ptr %__n.casted.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %20 = load ptr, ptr %__first1.addr.ascast, align 8, !tbaa !16, !llvm.access.group !29
  %21 = load ptr, ptr %__first2.addr.ascast, align 8, !tbaa !16, !llvm.access.group !29
  %22 = getelementptr inbounds [8 x ptr], ptr %captured_vars_addrs.ascast, i64 0, i64 0
  %23 = inttoptr i64 %16 to ptr
  store ptr %23, ptr %22, align 8, !tbaa !16, !llvm.access.group !29
  %24 = getelementptr inbounds [8 x ptr], ptr %captured_vars_addrs.ascast, i64 0, i64 1
  %25 = inttoptr i64 %17 to ptr
  store ptr %25, ptr %24, align 8, !tbaa !16, !llvm.access.group !29
  %26 = getelementptr inbounds [8 x ptr], ptr %captured_vars_addrs.ascast, i64 0, i64 2
  %27 = inttoptr i64 %19 to ptr
  store ptr %27, ptr %26, align 8, !tbaa !16, !llvm.access.group !29
  %28 = getelementptr inbounds [8 x ptr], ptr %captured_vars_addrs.ascast, i64 0, i64 3
  store ptr %__init1.ascast, ptr %28, align 8, !tbaa !16, !llvm.access.group !29
  %29 = getelementptr inbounds [8 x ptr], ptr %captured_vars_addrs.ascast, i64 0, i64 4
  store ptr %1, ptr %29, align 8, !tbaa !16, !llvm.access.group !29
  %30 = getelementptr inbounds [8 x ptr], ptr %captured_vars_addrs.ascast, i64 0, i64 5
  store ptr %__transform4.ascast, ptr %30, align 8, !tbaa !16, !llvm.access.group !29
  %31 = getelementptr inbounds [8 x ptr], ptr %captured_vars_addrs.ascast, i64 0, i64 6
  store ptr %20, ptr %31, align 8, !tbaa !16, !llvm.access.group !29
  %32 = getelementptr inbounds [8 x ptr], ptr %captured_vars_addrs.ascast, i64 0, i64 7
  store ptr %21, ptr %32, align 8, !tbaa !16, !llvm.access.group !29
  %33 = load ptr, ptr %.global_tid..addr.ascast, align 8, !llvm.access.group !29
  %34 = load i32, ptr %33, align 4, !tbaa !18, !llvm.access.group !29
  call void @__kmpc_parallel_51(ptr addrspacecast (ptr addrspace(1) @1 to ptr), i32 %34, i32 1, i32 -1, i32 -1, ptr @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_omp_outlined_omp_outlined, ptr null, ptr %captured_vars_addrs.ascast, i64 8), !llvm.access.group !29
  br label %omp.inner.for.inc

omp.inner.for.inc:                                ; preds = %omp.inner.for.body
  %35 = load i64, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %36 = load i64, ptr %.omp.stride.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %add8 = add nsw i64 %35, %36
  store i64 %add8, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %37 = load i64, ptr %.omp.comb.lb.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %38 = load i64, ptr %.omp.stride.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %add9 = add nsw i64 %37, %38
  store i64 %add9, ptr %.omp.comb.lb.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %39 = load i64, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %40 = load i64, ptr %.omp.stride.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %add10 = add nsw i64 %39, %40
  store i64 %add10, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %41 = load i64, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %42 = load i64, ptr %.capture_expr.2.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %cmp11 = icmp sgt i64 %41, %42
  br i1 %cmp11, label %cond.true12, label %cond.false13

cond.true12:                                      ; preds = %omp.inner.for.inc
  %43 = load i64, ptr %.capture_expr.2.ascast, align 8, !tbaa !12, !llvm.access.group !29
  br label %cond.end14

cond.false13:                                     ; preds = %omp.inner.for.inc
  %44 = load i64, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12, !llvm.access.group !29
  br label %cond.end14

cond.end14:                                       ; preds = %cond.false13, %cond.true12
  %cond15 = phi i64 [ %43, %cond.true12 ], [ %44, %cond.false13 ]
  store i64 %cond15, ptr %.omp.comb.ub.ascast, align 8, !tbaa !12, !llvm.access.group !29
  %45 = load i64, ptr %.omp.comb.lb.ascast, align 8, !tbaa !12, !llvm.access.group !29
  store i64 %45, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !29
...
.omp.reduction.then:                              ; preds = %omp.precond.end
  %57 = load float, ptr %0, align 4, !tbaa !25
  %58 = load float, ptr %__init1.ascast, align 4, !tbaa !25
  %add19 = fadd float %57, %58
  store float %add19, ptr %0, align 4, !tbaa !25
...
omp.precond.then:                                 ; preds = %entry
  ...
  store i64 0, ptr %.omp.lb.ascast, align 8, !tbaa !12
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %.omp.ub) #3
  %6 = load i64, ptr %.capture_expr.1.ascast, align 8, !tbaa !12
  store i64 %6, ptr %.omp.ub.ascast, align 8, !tbaa !12
  %7 = load i64, ptr %.previous.lb..addr.ascast, align 8, !tbaa !12
  %8 = load i64, ptr %.previous.ub..addr.ascast, align 8, !tbaa !12
  store i64 %7, ptr %.omp.lb.ascast, align 8, !tbaa !12
  ...
  store float 0.000000e+00, ptr %__init4.ascast, align 4, !tbaa !25
  call void @llvm.lifetime.start.p5(i64 8, ptr addrspace(5) %__i5) #3
  ...
  %11 = load i64, ptr %.omp.lb.ascast, align 8, !tbaa !12
  store i64 %11, ptr %.omp.iv.ascast, align 8, !tbaa !12
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %omp.precond.then
  %12 = load i64, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !32
  %13 = load i64, ptr %.previous.ub..addr.ascast, align 8, !tbaa !12, !llvm.access.group !32
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %14 = load i64, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !32
  %mul = mul nsw i64 %14, 1
  %add = add nsw i64 0, %mul
  store i64 %add, ptr %__i5.ascast, align 8, !tbaa !12, !llvm.access.group !32
  call void @llvm.lifetime.start.p5(i64 4, ptr addrspace(5) %ref.tmp) #3, !llvm.access.group !32
  %15 = load ptr, ptr %__first1.addr.ascast, align 8, !tbaa !16, !llvm.access.group !32
  %16 = load i64, ptr %__i5.ascast, align 8, !tbaa !12, !llvm.access.group !32
  %arrayidx = getelementptr inbounds float, ptr %15, i64 %16
  %17 = load float, ptr %arrayidx, align 4, !tbaa !25, !llvm.access.group !32
  %18 = load ptr, ptr %__first2.addr.ascast, align 8, !tbaa !16, !llvm.access.group !32
  %19 = load i64, ptr %__i5.ascast, align 8, !tbaa !12, !llvm.access.group !32
  %arrayidx7 = getelementptr inbounds float, ptr %18, i64 %19
  %20 = load float, ptr %arrayidx7, align 4, !tbaa !25, !llvm.access.group !32
  %call = call noundef float @_ZZ3dotIffET_RNSt3__16vectorIS0_NS1_9allocatorIS0_EEEERNS2_IT0_NS3_IS7_EEEEENKUlffE_clEff(ptr noundef nonnull align 1 dereferenceable(1) %__transform3.ascast, float noundef %17, float noundef %20) #9, !llvm.access.group !32
  store float %call, ptr %ref.tmp.ascast, align 4, !tbaa !25, !llvm.access.group !32
  %call8 = call noundef float @_ZNKSt3__14plusIfEclB7v180000ERKfS3_(ptr noundef nonnull align 1 dereferenceable(1) %1, ptr noundef nonnull align 4 dereferenceable(4) %__init4.ascast, ptr noundef nonnull align 4 dereferenceable(4) %ref.tmp.ascast) #9, !llvm.access.group !32
  store float %call8, ptr %__init4.ascast, align 4, !tbaa !25, !llvm.access.group !32
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %ref.tmp) #3, !llvm.access.group !32
  br label %omp.body.continue
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %21 = load i64, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !32
  %22 = load i64, ptr %.omp.stride.ascast, align 8, !tbaa !12, !llvm.access.group !32
  %add9 = add nsw i64 %21, %22
  store i64 %add9, ptr %.omp.iv.ascast, align 8, !tbaa !12, !llvm.access.group !32
...
.omp.reduction.then:                              ; preds = %.omp.final.done
  %33 = load float, ptr %0, align 4, !tbaa !25
  %34 = load float, ptr %__init4.ascast, align 4, !tbaa !25
  %add14 = fadd float %33, %34
  store float %add14, ptr %0, align 4, !tbaa !25
...
entry:
  ...
  %1 = load float, ptr %0, align 4, !tbaa !25
...
define linkonce_odr hidden noundef float @_ZZ3dotIffET_RNSt3__16vectorIS0_NS1_9allocatorIS0_EEEERNS2_IT0_NS3_IS7_EEEEENKUlffE_clEff(ptr noundef nonnull align 1 dereferenceable(1) %this, float noundef %xi, float noundef %yi) #6 comdat align 2 {
entry:
  %retval = alloca float, align 4, addrspace(5)
  %this.addr = alloca ptr, align 8, addrspace(5)
  ...
  store ptr %this, ptr %this.addr.ascast, align 8, !tbaa !16
  store float %xi, ptr %xi.addr.ascast, align 4, !tbaa !25
  store float %yi, ptr %yi.addr.ascast, align 4, !tbaa !25
  %this1 = load ptr, ptr %this.addr.ascast, align 8
  %0 = load float, ptr %xi.addr.ascast, align 4, !tbaa !25
  %1 = load float, ptr %yi.addr.ascast, align 4, !tbaa !25
  %add = fadd float %0, %1
  ret float %add
}

; Function Attrs: convergent norecurse nounwind
define internal void @"__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_omp_outlined_omp_outlined_omp$reduction$reduction_func"(ptr noundef %0, ptr noundef %1) #7 {
entry:
  ...
  %add = fadd float %8, %9
  store float %add, ptr %7, align 4, !tbaa !25
  ret void
}
...
entry:
  ...
  store ptr %0, ptr %.addr.ascast, align 8, !tbaa !16
  store i16 %1, ptr %.addr1.ascast, align 2, !tbaa !35
  store i16 %2, ptr %.addr2.ascast, align 2, !tbaa !35
  store i16 %3, ptr %.addr3.ascast, align 2, !tbaa !35
  %4 = load ptr, ptr %.addr.ascast, align 8, !tbaa !16
  %5 = load i16, ptr %.addr1.ascast, align 2, !tbaa !35
  %6 = load i16, ptr %.addr2.ascast, align 2, !tbaa !35
  %7 = load i16, ptr %.addr3.ascast, align 2, !tbaa !35
...
then:                                             ; preds = %entry
  call void @"__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_omp_outlined_omp_outlined_omp$reduction$reduction_func"(ptr %4, ptr %.omp.reduction.remote_reduce_list.ascast) #3
  br label %ifcont
...
; Function Attrs: convergent norecurse nounwind
define internal void @"__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_omp_outlined_omp$reduction$reduction_func"(ptr noundef %0, ptr noundef %1) #7 {
entry:
  %.addr = alloca ptr, align 8, addrspace(5)
  %.addr1 = alloca ptr, align 8, addrspace(5)
  %.addr.ascast = addrspacecast ptr addrspace(5) %.addr to ptr
...
then:                                             ; preds = %entry
  call void @"__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend35__omp_parallel_for_simd_reduction_2B7v180000IPfS3_lffZ3dotIffET_RNS_6vectorIS5_NS_9allocatorIS5_EEEERNS6_IT0_NS7_ISB_EEEEEUlffE_EET2_S5_SB_T1_SG_NS_4plusIT3_EET4_i_l341_omp_outlined_omp$reduction$reduction_func"(ptr %4, ptr %.omp.reduction.remote_reduce_list.ascast) #3
  br label %ifcont
...
entry:
  ...
  store float %9, ptr %8, align 128, !tbaa !37
  ret void
}
...
entry:
  ...
  %__init = getelementptr inbounds %struct._globalized_locals_ty.20, ptr %4, i32 0, i32 0
  %8 = getelementptr inbounds [1024 x float], ptr %__init, i32 0, i32 %5
  %9 = load float, ptr %8, align 128, !tbaa !37
...
!36 = !{!"short", !14, i64 0}
!37 = !{!38, !14, i64 0}
!38 = !{!"_ZTS21_globalized_locals_ty", !14, i64 0}
