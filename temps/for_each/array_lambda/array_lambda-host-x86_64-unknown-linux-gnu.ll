...
cond.false:                                       ; preds = %for.body
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 12, ptr noundef @__PRETTY_FUNCTION__.main) #16
  unreachable
...
cond.false7:                                      ; preds = %cond.end
  call void @__assert_fail(ptr noundef @.str.2, ptr noundef @.str.1, i32 noundef 13, ptr noundef @__PRETTY_FUNCTION__.main) #16
  unreachable
...
invoke.cont1:                                     ; preds = %invoke.cont
  ...
  store i64 %3, ptr %__n.casted, align 8, !tbaa !20
  %4 = load i64, ptr %__n.casted, align 8, !tbaa !20
  ...
  %7 = load i64, ptr %.capture_expr..casted, align 8, !tbaa !20
...
omp_if.then:                                      ; preds = %invoke.cont1
  ...
  %25 = load i64, ptr %__n.addr, align 8, !tbaa !20
  store i64 %25, ptr %.capture_expr.5, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %.capture_expr.6) #10
  %26 = load i64, ptr %.capture_expr.5, align 8, !tbaa !20
  %sub = sub nsw i64 %26, 0
  %div = sdiv i64 %sub, 1
  %sub7 = sub nsw i64 %div, 1
  store i64 %sub7, ptr %.capture_expr.6, align 8, !tbaa !20
  call void @llvm.lifetime.end.p0(i64 8, ptr %.capture_expr.6) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %.capture_expr.5) #10
  %27 = load i64, ptr %.capture_expr.6, align 8, !tbaa !20
...
omp_offload.failed:                               ; preds = %omp_if.then
  call void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_0EET_S3_T0_T1__l30"(i64 %4, ptr %__f, ptr %5, i64 %7) #10
...
omp_if.end:                                       ; preds = %omp_if.else, %omp_offload.cont
  ...
  %44 = load ptr, ptr %__first.addr, align 8, !tbaa !8
  %45 = load i64, ptr %__n.addr, align 8, !tbaa !20
  invoke void @_Z10OMPMapFromIPilEvT_T0_(ptr noundef %44, i64 noundef %45)
          to label %invoke.cont8 unwind label %terminate.lpad

invoke.cont8:                                     ; preds = %omp_if.end
  %46 = load ptr, ptr %__first.addr, align 8, !tbaa !8
  %47 = load i64, ptr %__n.addr, align 8, !tbaa !20
...
entry:
  ...
  %1 = load i64, ptr %length.addr, align 8, !tbaa !20
...
define internal void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_0EET_S3_T0_T1__l30"(i64 noundef %__n, ptr noundef nonnull align 1 dereferenceable(1) %__f, ptr noundef %__first, i64 noundef %.capture_expr.) #9 {
entry:
  %__n.addr = alloca i64, align 8
  ...
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !8
  store i64 %.capture_expr., ptr %.capture_expr..addr, align 8, !tbaa !20
  %0 = load ptr, ptr %__f.addr, align 8, !tbaa !8
  %1 = load i64, ptr %__n.addr, align 8, !tbaa !20
  store i64 %1, ptr %__n.casted, align 8, !tbaa !20
  %2 = load i64, ptr %__n.casted, align 8, !tbaa !20
  %3 = load ptr, ptr %__first.addr, align 8, !tbaa !8
  ...
  %5 = load i64, ptr %.capture_expr..casted, align 8, !tbaa !20
...
entry:
  ...
  %1 = load i64, ptr %__n.addr, align 8, !tbaa !20
  store i64 %1, ptr %.capture_expr.1, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %.capture_expr.2) #10
  %2 = load i64, ptr %.capture_expr.1, align 8, !tbaa !20
  %sub = sub nsw i64 %2, 0
  %div = sdiv i64 %sub, 1
  %sub3 = sub nsw i64 %div, 1
  store i64 %sub3, ptr %.capture_expr.2, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %__i) #10
  store i64 0, ptr %__i, align 8, !tbaa !20
  call void @llvm.lifetime.end.p0(i64 8, ptr %__i) #10
  %3 = load i64, ptr %.capture_expr.1, align 8, !tbaa !20
  %cmp = icmp slt i64 0, %3
  br i1 %cmp, label %omp.precond.then, label %omp.precond.end

omp.precond.then:                                 ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.comb.lb) #10
  store i64 0, ptr %.omp.comb.lb, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.comb.ub) #10
  %4 = load i64, ptr %.capture_expr.2, align 8, !tbaa !20
  store i64 %4, ptr %.omp.comb.ub, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.stride) #10
  store i64 1, ptr %.omp.stride, align 8, !tbaa !20
  ...
  %7 = load i64, ptr %.omp.comb.ub, align 8, !tbaa !20
  %8 = load i64, ptr %.capture_expr.2, align 8, !tbaa !20
  %cmp6 = icmp sgt i64 %7, %8
  br i1 %cmp6, label %cond.true, label %cond.false

cond.true:                                        ; preds = %omp.precond.then
  %9 = load i64, ptr %.capture_expr.2, align 8, !tbaa !20
  br label %cond.end

cond.false:                                       ; preds = %omp.precond.then
  %10 = load i64, ptr %.omp.comb.ub, align 8, !tbaa !20
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %9, %cond.true ], [ %10, %cond.false ]
  store i64 %cond, ptr %.omp.comb.ub, align 8, !tbaa !20
  %11 = load i64, ptr %.omp.comb.lb, align 8, !tbaa !20
  store i64 %11, ptr %.omp.iv, align 8, !tbaa !20
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %omp_if.then
  %13 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !26
  %14 = load i64, ptr %.omp.comb.ub, align 8, !tbaa !20, !llvm.access.group !26
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %17 = load i64, ptr %__n.addr, align 8, !tbaa !20, !llvm.access.group !26
  store i64 %17, ptr %__n.casted, align 8, !tbaa !20, !llvm.access.group !26
  %18 = load i64, ptr %__n.casted, align 8, !tbaa !20, !llvm.access.group !26
  %19 = load ptr, ptr %__first.addr, align 8, !tbaa !8, !llvm.access.group !26
  ...
  %21 = load i64, ptr %.capture_expr..casted, align 8, !tbaa !20, !llvm.access.group !26
...
omp_if.else:                                      ; preds = %omp.inner.for.body
  ...
  %24 = load i32, ptr %23, align 4, !tbaa !12, !llvm.access.group !26
  ...
  call void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_0EET_S3_T0_T1__l30.omp_outlined.omp_outlined"(ptr %25, ptr %.bound.zero.addr, i64 %15, i64 %16, i64 %18, ptr %__f4, ptr %19, i64 %21) #10, !llvm.access.group !26
...
omp.inner.for.inc:                                ; preds = %omp_if.end
  %26 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !26
  %27 = load i64, ptr %.omp.stride, align 8, !tbaa !20, !llvm.access.group !26
  %add = add nsw i64 %26, %27
  store i64 %add, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !26
...
omp.inner.for.cond12:                             ; preds = %omp.inner.for.inc25, %omp_if.else11
  %28 = load i64, ptr %.omp.iv, align 8, !tbaa !20
  %29 = load i64, ptr %.omp.comb.ub, align 8, !tbaa !20
...
omp.inner.for.body15:                             ; preds = %omp.inner.for.cond12
  ...
  %32 = load i64, ptr %__n.addr, align 8, !tbaa !20
  store i64 %32, ptr %__n.casted16, align 8, !tbaa !20
  %33 = load i64, ptr %__n.casted16, align 8, !tbaa !20
  ...
  %36 = load i64, ptr %.capture_expr..casted18, align 8, !tbaa !20
...
omp_if.else22:                                    ; preds = %omp.inner.for.body15
  ...
  call void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_0EET_S3_T0_T1__l30.omp_outlined.omp_outlined.3"(ptr %40, ptr %.bound.zero.addr23, i64 %30, i64 %31, i64 %33, ptr %__f4, ptr %34, i64 %36) #10
...
omp.inner.for.inc25:                              ; preds = %omp_if.end24
  %41 = load i64, ptr %.omp.iv, align 8, !tbaa !20
  %42 = load i64, ptr %.omp.stride, align 8, !tbaa !20
  %add26 = add nsw i64 %41, %42
  store i64 %add26, ptr %.omp.iv, align 8, !tbaa !20
...
entry:
  ...
  store ptr %.global_tid., ptr %.global_tid..addr, align 8, !tbaa !8
  store ptr %.bound_tid., ptr %.bound_tid..addr, align 8, !tbaa !8
  store i64 %.previous.lb., ptr %.previous.lb..addr, align 8, !tbaa !20
  store i64 %.previous.ub., ptr %.previous.ub..addr, align 8, !tbaa !20
  store i64 %__n, ptr %__n.addr, align 8, !tbaa !20
  store ptr %__f, ptr %__f.addr, align 8, !tbaa !8
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !8
  store i64 %.capture_expr., ptr %.capture_expr..addr, align 8, !tbaa !20
...
omp.precond.then:                                 ; preds = %entry
  ...
  store i64 0, ptr %.omp.lb, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.ub) #10
  %4 = load i64, ptr %.capture_expr.2, align 8, !tbaa !20
  store i64 %4, ptr %.omp.ub, align 8, !tbaa !20
  %5 = load i64, ptr %.previous.lb..addr, align 8, !tbaa !20
  %6 = load i64, ptr %.previous.ub..addr, align 8, !tbaa !20
  store i64 %5, ptr %.omp.lb, align 8, !tbaa !20
  store i64 %6, ptr %.omp.ub, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.stride) #10
  store i64 1, ptr %.omp.stride, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 4, ptr %.omp.is_last) #10
  store i32 0, ptr %.omp.is_last, align 4, !tbaa !12
...
omp_if.then:                                      ; preds = %omp.precond.then
  ...
  %10 = load i64, ptr %.omp.ub, align 8, !tbaa !20
  %11 = load i64, ptr %.capture_expr.2, align 8, !tbaa !20
  %cmp6 = icmp sgt i64 %10, %11
  br i1 %cmp6, label %cond.true, label %cond.false

cond.true:                                        ; preds = %omp_if.then
  %12 = load i64, ptr %.capture_expr.2, align 8, !tbaa !20
  br label %cond.end

cond.false:                                       ; preds = %omp_if.then
  %13 = load i64, ptr %.omp.ub, align 8, !tbaa !20
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi i64 [ %12, %cond.true ], [ %13, %cond.false ]
  store i64 %cond, ptr %.omp.ub, align 8, !tbaa !20
  %14 = load i64, ptr %.omp.lb, align 8, !tbaa !20
  store i64 %14, ptr %.omp.iv, align 8, !tbaa !20
  br label %omp.inner.for.cond

omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %cond.end
  %15 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !32
  %16 = load i64, ptr %.omp.ub, align 8, !tbaa !20, !llvm.access.group !32
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %17 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !32
  %mul = mul nsw i64 %17, 1
  %add = add nsw i64 0, %mul
  store i64 %add, ptr %__i5, align 8, !tbaa !20, !llvm.access.group !32
  %18 = load ptr, ptr %__first.addr, align 8, !tbaa !8, !llvm.access.group !32
  %19 = load i64, ptr %__i5, align 8, !tbaa !20, !llvm.access.group !32
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %20 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !32
  %add8 = add nsw i64 %20, 1
  store i64 %add8, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !32
...
omp_if.else:                                      ; preds = %omp.precond.then
  ...
  %23 = load i64, ptr %.omp.ub, align 8, !tbaa !20
  %24 = load i64, ptr %.capture_expr.2, align 8, !tbaa !20
  %cmp9 = icmp sgt i64 %23, %24
  br i1 %cmp9, label %cond.true10, label %cond.false11

cond.true10:                                      ; preds = %omp_if.else
  %25 = load i64, ptr %.capture_expr.2, align 8, !tbaa !20
  br label %cond.end12

cond.false11:                                     ; preds = %omp_if.else
  %26 = load i64, ptr %.omp.ub, align 8, !tbaa !20
  br label %cond.end12

cond.end12:                                       ; preds = %cond.false11, %cond.true10
  %cond13 = phi i64 [ %25, %cond.true10 ], [ %26, %cond.false11 ]
  store i64 %cond13, ptr %.omp.ub, align 8, !tbaa !20
  %27 = load i64, ptr %.omp.lb, align 8, !tbaa !20
  store i64 %27, ptr %.omp.iv, align 8, !tbaa !20
  br label %omp.inner.for.cond14

omp.inner.for.cond14:                             ; preds = %omp.inner.for.inc23, %cond.end12
  %28 = load i64, ptr %.omp.iv, align 8, !tbaa !20
  %29 = load i64, ptr %.omp.ub, align 8, !tbaa !20
...
omp.inner.for.body17:                             ; preds = %omp.inner.for.cond14
  %30 = load i64, ptr %.omp.iv, align 8, !tbaa !20
  %mul18 = mul nsw i64 %30, 1
  %add19 = add nsw i64 0, %mul18
  store i64 %add19, ptr %__i5, align 8, !tbaa !20
  %31 = load ptr, ptr %__first.addr, align 8, !tbaa !8
  %32 = load i64, ptr %__i5, align 8, !tbaa !20
...
omp.inner.for.inc23:                              ; preds = %omp.body.continue22
  %33 = load i64, ptr %.omp.iv, align 8, !tbaa !20
  %add24 = add nsw i64 %33, 1
  store i64 %add24, ptr %.omp.iv, align 8, !tbaa !20
...
terminate.lpad:                                   ; preds = %omp.inner.for.body17, %omp.inner.for.body
  ...
  call void @__clang_call_terminate(ptr %40) #16, !llvm.access.group !32
  unreachable
}
...
; Function Attrs: nounwind
declare !callback !36 void @__kmpc_fork_call(ptr, i32, ptr, ...) #10
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %cond.end
  %15 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !38
  %16 = load i64, ptr %.omp.ub, align 8, !tbaa !20, !llvm.access.group !38
  %cmp7 = icmp sle i64 %15, %16
  br i1 %cmp7, label %omp.inner.for.body, label %omp.inner.for.cond.cleanup
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %17 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !38
  %mul = mul nsw i64 %17, 1
  %add = add nsw i64 0, %mul
  store i64 %add, ptr %__i5, align 8, !tbaa !20, !llvm.access.group !38
  %18 = load ptr, ptr %__first.addr, align 8, !tbaa !8, !llvm.access.group !38
  %19 = load i64, ptr %__i5, align 8, !tbaa !20, !llvm.access.group !38
  %arrayidx = getelementptr inbounds i32, ptr %18, i64 %19
  invoke void @"_ZZ4mainENK3$_0clERi"(ptr noundef nonnull align 1 dereferenceable(1) %__f4, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx)
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %20 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !38
  %add8 = add nsw i64 %20, 1
  store i64 %add8, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !38
...
terminate.lpad:                                   ; preds = %omp.inner.for.body17, %omp.inner.for.body
  ...
  %40 = extractvalue { ptr, i32 } %39, 0
  call void @__clang_call_terminate(ptr %40) #16, !llvm.access.group !38
  unreachable
}

; Function Attrs: nounwind
declare !callback !36 void @__kmpc_fork_teams(ptr, i32, ptr, ...) #10

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef zeroext i1 @_Z16OMPIsOffloadableIlEbT_(i64 noundef %size) #6 comdat {
entry:
  %size.addr = alloca i64, align 8
  store i64 %size, ptr %size.addr, align 8, !tbaa !20
  %0 = load i64, ptr %size.addr, align 8, !tbaa !20
...
if.end3:                                          ; preds = %if.end
  ...
  %5 = load i64, ptr %length.addr, align 8, !tbaa !20
  %6 = mul nuw i64 %5, 4
...
; Function Attrs: mustprogress nounwind uwtable
define internal noundef ptr @"_ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_1EET_S3_T0_T1_"(ptr noundef %__first, i64 noundef %__n) #6 personality ptr @__gxx_personality_v0 {
entry:
...
omp_if.then:                                      ; preds = %invoke.cont
  ...
  %25 = load i64, ptr %__n.addr, align 8, !tbaa !20
  store i64 %25, ptr %.capture_expr.4, align 8, !tbaa !20
  call void @llvm.lifetime.start.p0(i64 8, ptr %.capture_expr.5) #10
  %26 = load i64, ptr %.capture_expr.4, align 8, !tbaa !20
  %sub = sub nsw i64 %26, 0
  %div = sdiv i64 %sub, 1
  %sub6 = sub nsw i64 %div, 1
  store i64 %sub6, ptr %.capture_expr.5, align 8, !tbaa !20
  call void @llvm.lifetime.end.p0(i64 8, ptr %.capture_expr.5) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr %.capture_expr.4) #10
  %27 = load i64, ptr %.capture_expr.5, align 8, !tbaa !20
  %add = add nsw i64 %27, 1
  %28 = insertvalue [3 x i32] zeroinitializer, i32 %24, 0
  %29 = getelementptr inbounds %struct.__tgt_kernel_arguments, ptr %kernel_args, i32 0, i32 0
  store i32 2, ptr %29, align 4
...
omp_offload.failed:                               ; preds = %omp_if.then
  call void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_1EET_S3_T0_T1__l30"(i64 %4, ptr %__f, ptr %5, i64 %7) #10
  br label %omp_offload.cont
...
; Function Attrs: alwaysinline norecurse nounwind uwtable
define internal void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_1EET_S3_T0_T1__l30"(i64 noundef %__n, ptr noundef nonnull align 1 dereferenceable(1) %__f, ptr noundef %__first, i64 noundef %.capture_expr.) #9 {
entry:
  %__n.addr = alloca i64, align 8
  %__f.addr = alloca ptr, align 8
  %__first.addr = alloca ptr, align 8
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %omp_if.then
  %13 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !46
  %14 = load i64, ptr %.omp.comb.ub, align 8, !tbaa !20, !llvm.access.group !46
  %cmp7 = icmp sle i64 %13, %14
  br i1 %cmp7, label %omp.inner.for.body, label %omp.inner.for.cond.cleanup
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %17 = load i64, ptr %__n.addr, align 8, !tbaa !20, !llvm.access.group !46
  store i64 %17, ptr %__n.casted, align 8, !tbaa !20, !llvm.access.group !46
  %18 = load i64, ptr %__n.casted, align 8, !tbaa !20, !llvm.access.group !46
  %19 = load ptr, ptr %__first.addr, align 8, !tbaa !8, !llvm.access.group !46
  ...
  %21 = load i64, ptr %.capture_expr..casted, align 8, !tbaa !20, !llvm.access.group !46
...
omp_if.else:                                      ; preds = %omp.inner.for.body
  ...
  %24 = load i32, ptr %23, align 4, !tbaa !12, !llvm.access.group !46
  ...
  call void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_1EET_S3_T0_T1__l30.omp_outlined.omp_outlined"(ptr %25, ptr %.bound.zero.addr, i64 %15, i64 %16, i64 %18, ptr %__f4, ptr %19, i64 %21) #10, !llvm.access.group !46
...
omp.inner.for.inc:                                ; preds = %omp_if.end
  %26 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !46
  %27 = load i64, ptr %.omp.stride, align 8, !tbaa !20, !llvm.access.group !46
  %add = add nsw i64 %26, %27
  store i64 %add, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !46
...
omp_if.else22:                                    ; preds = %omp.inner.for.body15
  ...
  %40 = load ptr, ptr %.global_tid..addr, align 8
  store i32 0, ptr %.bound.zero.addr23, align 4
  call void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_1EET_S3_T0_T1__l30.omp_outlined.omp_outlined.6"(ptr %40, ptr %.bound.zero.addr23, i64 %30, i64 %31, i64 %33, ptr %__f4, ptr %34, i64 %36) #10
  call void @__kmpc_end_serialized_parallel(ptr @3, i32 %39)
  br label %omp_if.end24
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %cond.end
  %15 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !50
  %16 = load i64, ptr %.omp.ub, align 8, !tbaa !20, !llvm.access.group !50
  %cmp7 = icmp sle i64 %15, %16
  br i1 %cmp7, label %omp.inner.for.body, label %omp.inner.for.cond.cleanup
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %17 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !50
  %mul = mul nsw i64 %17, 1
  %add = add nsw i64 0, %mul
  store i64 %add, ptr %__i5, align 8, !tbaa !20, !llvm.access.group !50
  %18 = load ptr, ptr %__first.addr, align 8, !tbaa !8, !llvm.access.group !50
  %19 = load i64, ptr %__i5, align 8, !tbaa !20, !llvm.access.group !50
  %arrayidx = getelementptr inbounds i32, ptr %18, i64 %19
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %20 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !50
  %add8 = add nsw i64 %20, 1
  store i64 %add8, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !50
...
terminate.lpad:                                   ; preds = %omp.inner.for.body17, %omp.inner.for.body
  ...
  %40 = extractvalue { ptr, i32 } %39, 0
  call void @__clang_call_terminate(ptr %40) #16, !llvm.access.group !50
  unreachable
}

; Function Attrs: inlinehint mustprogress nounwind uwtable
define internal void @"_ZZ4mainENK3$_1clERi"(ptr noundef nonnull align 1 dereferenceable(1) %this, ptr noundef nonnull align 4 dereferenceable(4) %n) #12 align 2 {
entry:
  %this.addr = alloca ptr, align 8
  %n.addr = alloca ptr, align 8
  store ptr %this, ptr %this.addr, align 8, !tbaa !8
...
omp.inner.for.cond:                               ; preds = %omp.inner.for.inc, %cond.end
  %15 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !54
  %16 = load i64, ptr %.omp.ub, align 8, !tbaa !20, !llvm.access.group !54
  %cmp7 = icmp sle i64 %15, %16
  br i1 %cmp7, label %omp.inner.for.body, label %omp.inner.for.cond.cleanup
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  %17 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !54
  %mul = mul nsw i64 %17, 1
  %add = add nsw i64 0, %mul
  store i64 %add, ptr %__i5, align 8, !tbaa !20, !llvm.access.group !54
  %18 = load ptr, ptr %__first.addr, align 8, !tbaa !8, !llvm.access.group !54
  %19 = load i64, ptr %__i5, align 8, !tbaa !20, !llvm.access.group !54
  %arrayidx = getelementptr inbounds i32, ptr %18, i64 %19
  invoke void @"_ZZ4mainENK3$_1clERi"(ptr noundef nonnull align 1 dereferenceable(1) %__f4, ptr noundef nonnull align 4 dereferenceable(4) %arrayidx)
...
omp.inner.for.inc:                                ; preds = %omp.body.continue
  %20 = load i64, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !54
  %add8 = add nsw i64 %20, 1
  store i64 %add8, ptr %.omp.iv, align 8, !tbaa !20, !llvm.access.group !54
...
terminate.lpad:                                   ; preds = %omp.inner.for.body17, %omp.inner.for.body
  ...
  %40 = extractvalue { ptr, i32 } %39, 0
  call void @__clang_call_terminate(ptr %40) #16, !llvm.access.group !54
  unreachable
}
...
!16 = !{!17, !9, i64 0}
!17 = !{!"_ZTSZNSt3__115__pstl_for_eachB7v180000INS_9execution27parallel_unsequenced_policyEPiZ4mainE3$_0EEvNS_17__cpu_backend_tagET0_S6_T1_EUlvE_", !9, i64 0, !9, i64 8, !9, i64 16}
!18 = !{!17, !9, i64 8}
!19 = !{!17, !9, i64 16}
!20 = !{!21, !21, i64 0}
!21 = !{!"long", !10, i64 0}
...
!41 = distinct !{!41, !31}
!42 = !{!43, !9, i64 0}
!43 = !{!"_ZTSZNSt3__115__pstl_for_eachB7v180000INS_9execution27parallel_unsequenced_policyEPiZ4mainE3$_1EEvNS_17__cpu_backend_tagET0_S6_T1_EUlvE_", !9, i64 0, !9, i64 8, !9, i64 16}
!44 = !{!43, !9, i64 8}
!45 = !{!43, !9, i64 16}
!46 = distinct !{}
