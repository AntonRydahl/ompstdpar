; ModuleID = 'temps/for_each/array_lambda/array_lambda.amdgcn-amd-amdhsa.gfx906.postopt.bc'
...
; Function Attrs: alwaysinline norecurse nounwind
define weak_odr protected amdgpu_kernel void @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPilZ4mainE3$_1EET_S3_T0_T1__l30"(i64 noundef %0, ptr noundef nonnull align 1 dereferenceable(1) %1, ptr noundef %2, i64 noundef %3) local_unnamed_addr #0 {
  %5 = tail call i32 @llvm.amdgcn.workitem.id.x() #5, !range !14, !noundef !15
  %6 = icmp eq i32 %5, 0
  br i1 %6, label %7, label %8
