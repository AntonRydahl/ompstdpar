; ModuleID = 'temps/for_each/array_lambda_declare_target/array_lambda_declare_target-openmp-amdgcn-amd-amdhsa-gfx906.bc'
...
@"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPil3$_1EET_S3_T0_T1__l30_dynamic_environment" = weak_odr protected addrspace(1) global %struct.DynamicEnvironmentTy.14 zeroinitializer
@"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPil3$_1EET_S3_T0_T1__l30_kernel_environment" = weak_odr protected addrspace(1) constant %struct.KernelEnvironmentTy.16 { %struct.ConfigurationEnvironmentTy.15 { i8 0, i8 0, i8 2 }, ptr addrspacecast (ptr addrspace(1) @1 to ptr), ptr addrspacecast (ptr addrspace(1) @"__omp_offloading_16_21c8256b__ZNSt3__113__simd_walk_1B7v180000IPil3$_1EET_S3_T0_T1__l30_dynamic_environment" to ptr) }
@init = internal addrspace(1) global %class.anon.17 undef, align 1
@"_init$ref" = internal constant ptr addrspace(1) @init, align 8
@increment = internal addrspace(1) global %class.anon.0.18 undef, align 1
...
omp.inner.for.body:                               ; preds = %omp.inner.for.body.lr.ph, %omp.inner.for.body
  ...
  store i32 -1, ptr %arrayidx, align 4, !tbaa !18
...
omp.inner.for.body11:                             ; preds = %omp.inner.for.body11.lr.ph, %omp.inner.for.body11
  ...
  store i32 -1, ptr %arrayidx14, align 4, !tbaa !18
...
entry:
  ...
  %.omp.stride.i = alloca i64, align 8, addrspace(5)
  %.omp.is_last.i = alloca i32, align 4, addrspace(5)
  %__f4.i = alloca %class.anon.0.18, align 1, addrspace(5)
  %captured_vars_addrs.i = alloca [6 x ptr], align 8, addrspace(5)
  %captured_vars_addrs27.i = alloca [6 x ptr], align 8, addrspace(5)
...
omp.inner.for.body.lr.ph:                         ; preds = %omp_if.then
  %3 = load i64, ptr addrspace(5) %.omp.stride, align 8, !tbaa !14, !llvm.access.group !40
  br label %omp.inner.for.body
...
omp.inner.for.body:                               ; preds = %omp.inner.for.body.lr.ph, %omp.inner.for.body
  ...
  store i32 %inc.i, ptr %arrayidx, align 4, !tbaa !18
...
omp.inner.for.body11.lr.ph:                       ; preds = %omp_if.else
  %5 = load i64, ptr addrspace(5) %.omp.stride, align 8, !tbaa !14
  br label %omp.inner.for.body11
...
omp.inner.for.body11:                             ; preds = %omp.inner.for.body11.lr.ph, %omp.inner.for.body11
  ...
  %6 = load i32, ptr %arrayidx14, align 4, !tbaa !18
  %inc.i14 = add nsw i32 %6, 1
  store i32 %inc.i14, ptr %arrayidx14, align 4, !tbaa !18
...
omp.inner.for.body.lr.ph:                         ; preds = %omp_if.then
  %3 = load i64, ptr addrspace(5) %.omp.stride, align 8, !tbaa !14, !llvm.access.group !44
  br label %omp.inner.for.body
