; ModuleID = 'temps/for_each/struct_call_operator/struct_call_operator-openmp-amdgcn-amd-amdhsa-gfx906.bc'
...
@__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_dynamic_environment = weak_odr protected addrspace(1) global %struct.DynamicEnvironmentTy.8 zeroinitializer
@__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_kernel_environment = weak_odr protected addrspace(1) constant %struct.KernelEnvironmentTy.10 { %struct.ConfigurationEnvironmentTy.9 { i8 0, i8 0, i8 2 }, ptr addrspacecast (ptr addrspace(1) @1 to ptr), ptr addrspacecast (ptr addrspace(1) @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_dynamic_environment to ptr) }
...
entry:
  ...
  %__f3.i = alloca %class.anon.11, align 8, addrspace(5)
...
omp.precond.then.i:                               ; preds = %user_code.entry
  ...
  store i64 %__f.val, ptr addrspace(5) %__f3.i, align 8, !tbaa !18
...
omp.precond.then:                                 ; preds = %entry
  ...
  %0 = load i64, ptr %__f, align 8, !tbaa !18
  %1 = inttoptr i64 %0 to ptr
  %2 = load i32, ptr %.global_tid., align 4, !tbaa !16
  ...
  %3 = load i64, ptr addrspace(5) %.omp.lb, align 8, !tbaa !12
...
omp.inner.for.body.lr.ph:                         ; preds = %omp.precond.then
  %4 = load i64, ptr addrspace(5) %.omp.stride, align 8, !tbaa !12, !llvm.access.group !24
...
omp.inner.for.body:                               ; preds = %omp.inner.for.body.lr.ph, %omp.inner.for.body
  ...
  %__f3.ascast.val.val = load i32, ptr %1, align 4, !tbaa !16
  store i32 %__f3.ascast.val.val, ptr %arrayidx, align 4, !tbaa !16
...
; Function Attrs: alwaysinline norecurse nounwind
define weak_odr protected amdgpu_kernel void @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81(i64 noundef %__n, ptr noundef nonnull align 1 dereferenceable(1) %__f, ptr noundef %__first) local_unnamed_addr #0 {
entry:
  %.omp.comb.lb.i = alloca i64, align 8, addrspace(5)
  %.omp.comb.ub.i = alloca i64, align 8, addrspace(5)
  %.omp.stride.i = alloca i64, align 8, addrspace(5)
  %.omp.is_last.i = alloca i32, align 4, addrspace(5)
  %captured_vars_addrs.i = alloca [5 x ptr], align 8, addrspace(5)
  %0 = tail call i32 @__kmpc_target_init(ptr addrspacecast (ptr addrspace(1) @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_kernel_environment to ptr)) #2
  %exec_user_code = icmp eq i32 %0, -1
  br i1 %exec_user_code, label %user_code.entry, label %common.ret

common.ret:                                       ; preds = %entry, %__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_omp_outlined.exit
  ret void
...
user_code.entry:                                  ; preds = %entry
  ...
  %sub2.i = add nsw i64 %__n, -1
  %cmp.i = icmp sgt i64 %__n, 0
  br i1 %cmp.i, label %omp.precond.then.i, label %__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_omp_outlined.exit
...
omp.inner.for.body.i:                             ; preds = %omp.inner.for.body.i, %omp.inner.for.body.lr.ph.i
  ...
  store ptr %__f, ptr addrspace(5) %6, align 8, !tbaa !18, !llvm.access.group !27
  store ptr %__first, ptr addrspace(5) %7, align 8, !tbaa !18, !llvm.access.group !27
  call void @__kmpc_parallel_51(ptr addrspacecast (ptr addrspace(1) @1 to ptr), i32 %1, i32 1, i32 -1, i32 -1, ptr nonnull @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_omp_outlined_omp_outlined, ptr null, ptr nonnull %captured_vars_addrs.ascast.i, i64 5) #2, !llvm.access.group !27
  ...
  store i64 %add7.i, ptr addrspace(5) %.omp.comb.lb.i, align 8, !tbaa !12, !llvm.access.group !27
  ...
  store i64 %cond13.i, ptr addrspace(5) %.omp.comb.ub.i, align 8, !tbaa !12
  %cmp5.i = icmp slt i64 %add7.i, %__n
  br i1 %cmp5.i, label %omp.inner.for.body.i, label %omp.loop.exit.i, !llvm.loop !28

omp.loop.exit.i:                                  ; preds = %omp.inner.for.body.i, %omp.precond.then.i
  call void @__kmpc_distribute_static_fini(ptr addrspacecast (ptr addrspace(1) @2 to ptr), i32 %1) #2
  br label %__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_omp_outlined.exit

__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend25__omp_parallel_for_simd_1B7v180000IPil7squaredEET_S5_T0_T1_i_l81_omp_outlined.exit: ; preds = %user_code.entry, %omp.loop.exit.i
  call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) %.omp.is_last.i) #2
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %.omp.stride.i) #2
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %.omp.comb.ub.i) #2
  call void @llvm.lifetime.end.p5(i64 8, ptr addrspace(5) %.omp.comb.lb.i) #2
...
omp.precond.then:                                 ; preds = %entry
  ...
  br i1 %cmp4.not7, label %omp.loop.exit, label %omp.inner.for.body.lr.ph
...
omp.inner.for.body:                               ; preds = %omp.inner.for.body.lr.ph, %omp.inner.for.body
  %.omp.iv.08 = phi i64 [ %1, %omp.inner.for.body.lr.ph ], [ %add5, %omp.inner.for.body ]
  %arrayidx = getelementptr inbounds i32, ptr %__first, i64 %.omp.iv.08
  %3 = load i32, ptr %arrayidx, align 4, !tbaa !16
  %mul.i = mul nsw i32 %3, %3
  store i32 %mul.i, ptr %arrayidx, align 4, !tbaa !16
  %add5 = add nsw i64 %2, %.omp.iv.08
  %cmp4.not = icmp ugt i64 %add5, %.previous.ub.
  br i1 %cmp4.not, label %omp.loop.exit, label %omp.inner.for.body, !llvm.loop !31
