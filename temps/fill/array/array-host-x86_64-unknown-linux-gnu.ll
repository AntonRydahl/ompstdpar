...
entry:
  ...
  store ptr %call, ptr %a, align 8, !tbaa !7
...
for.end:                                          ; preds = %for.cond.cleanup
  call void @llvm.lifetime.start.p0(i64 4, ptr %i1) #11
  store i32 0, ptr %i1, align 4, !tbaa !11
  br label %for.cond2

for.cond2:                                        ; preds = %for.inc13, %for.end
  %5 = load i32, ptr %i1, align 4, !tbaa !11
  %cmp3 = icmp slt i32 %5, 10
  br i1 %cmp3, label %for.body5, label %for.cond.cleanup4

for.cond.cleanup4:                                ; preds = %for.cond2
  call void @llvm.lifetime.end.p0(i64 4, ptr %i1) #11
  br label %for.end15

for.body5:                                        ; preds = %for.cond2
  %6 = load ptr, ptr %a, align 8, !tbaa !7
  %7 = load ptr, ptr %a, align 8, !tbaa !7
  %add.ptr = getelementptr inbounds i32, ptr %7, i64 35791394
  call void @_ZNSt3__14fillB7v180000IRKNS_9execution27parallel_unsequenced_policyEPiiS2_TnNS_9enable_ifIX21is_execution_policy_vIT2_EEiE4typeELi0EEEvOT_T0_SC_RKT1_(ptr noundef nonnull align 1 dereferenceable(1) @_ZNSt3__19execution9par_unseqE, ptr noundef %6, ptr noundef %add.ptr, ptr noundef nonnull align 4 dereferenceable(4) %i1)
  %8 = load ptr, ptr %a, align 8, !tbaa !7
  %arrayidx6 = getelementptr inbounds i32, ptr %8, i64 0
  %9 = load i32, ptr %arrayidx6, align 4, !tbaa !11
  %10 = load i32, ptr %i1, align 4, !tbaa !11
...
cond.false:                                       ; preds = %for.body5
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 12, ptr noundef @__PRETTY_FUNCTION__.main) #15
  unreachable
...
cond.end:                                         ; preds = %11, %cond.true
  ...
  %arrayidx8 = getelementptr inbounds i32, ptr %12, i64 35791393
  %13 = load i32, ptr %arrayidx8, align 4, !tbaa !11
  %14 = load i32, ptr %i1, align 4, !tbaa !11
...
cond.false11:                                     ; preds = %cond.end
  call void @__assert_fail(ptr noundef @.str.2, ptr noundef @.str.1, i32 noundef 13, ptr noundef @__PRETTY_FUNCTION__.main) #15
  unreachable
...
for.inc13:                                        ; preds = %cond.end12
  %16 = load i32, ptr %i1, align 4, !tbaa !11
  %inc14 = add nsw i32 %16, 1
  store i32 %inc14, ptr %i1, align 4, !tbaa !11
  br label %for.cond2, !llvm.loop !15

for.end15:                                        ; preds = %for.cond.cleanup4
  %17 = load ptr, ptr %a, align 8, !tbaa !7
...
entry:
  ...
  store ptr %__policy, ptr %__policy.addr, align 8, !tbaa !7
  ...
  %1 = load ptr, ptr %__policy.addr, align 8, !tbaa !7
...
define linkonce_odr hidden void @_ZNSt3__111__pstl_fillB7v180000INS_9execution27parallel_unsequenced_policyEPiiEEvNS_17__gpu_backend_tagET0_S5_RKT1_(ptr noundef %__first, ptr noundef %__last, ptr noundef nonnull align 4 dereferenceable(4) %__value) #7 comdat {
entry:
  ...
  %call = call noundef ptr @_ZNSt3__113__par_backend17__omp_gpu_backend25__parallel_for_simd_val_1B7v180000IPiliEET_S4_T0_RKT1_(ptr noundef %1, i64 noundef %sub.ptr.div, ptr noundef nonnull align 4 dereferenceable(4) %4) #11
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr hidden noundef ptr @_ZNSt3__113__par_backend17__omp_gpu_backend25__parallel_for_simd_val_1B7v180000IPiliEET_S4_T0_RKT1_(ptr noundef %__first, i64 noundef %__n, ptr noundef nonnull align 4 dereferenceable(4) %__value) #7 comdat personality ptr @__gxx_personality_v0 {
entry:
  %__first.addr = alloca ptr, align 8
...
invoke.cont:                                      ; preds = %entry
  ...
  %2 = load ptr, ptr %__value.addr, align 8, !tbaa !7
  %call1 = call noundef ptr @_ZNSt3__113__par_backend17__omp_gpu_backend29__omp_parallel_for_simd_val_1B7v180000IPiliEET_S4_T0_RKT1_i(ptr noundef %call, i64 noundef %1, ptr noundef nonnull align 4 dereferenceable(4) %2, i32 noundef 0) #11
  %3 = load ptr, ptr %__first.addr, align 8, !tbaa !7
...
entry:
  ...
  store i64 %__n, ptr %__n.addr, align 8, !tbaa !16
  store ptr %__value, ptr %__value.addr, align 8, !tbaa !7
  store i32 %__device, ptr %__device.addr, align 4, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 4, ptr %.capture_expr.) #11
  %0 = load i32, ptr %__device.addr, align 4, !tbaa !11
  store i32 %0, ptr %.capture_expr., align 4, !tbaa !11
  ...
  %5 = load ptr, ptr %tmp, align 8, !tbaa !7
  ...
  %9 = mul nuw i64 %8, 4
  %10 = load ptr, ptr %tmp, align 8, !tbaa !7
  %11 = load ptr, ptr %tmp, align 8, !tbaa !7
  ...
  %25 = load i32, ptr %.capture_expr., align 4, !tbaa !11
  %26 = sext i32 %25 to i64
  call void @llvm.lifetime.start.p0(i64 8, ptr %.capture_expr.2) #11
  %27 = load i64, ptr %__n.addr, align 8, !tbaa !16
  store i64 %27, ptr %.capture_expr.2, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(i64 8, ptr %.capture_expr.3) #11
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr %.capture_expr.3) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.capture_expr.2) #11
...
omp_offload.failed:                               ; preds = %entry
  call void @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend29__omp_parallel_for_simd_val_1B7v180000IPiliEET_S4_T0_RKT1_i_l101(i64 %3, ptr %4, ptr %5) #11
  br label %omp_offload.cont

omp_offload.cont:                                 ; preds = %omp_offload.failed, %entry
  call void @llvm.lifetime.end.p0(i64 4, ptr %.capture_expr.) #11
  %45 = load ptr, ptr %__first.addr, align 8, !tbaa !7
...
define linkonce_odr hidden noundef ptr @_ZNSt3__113__par_backend17__omp_gpu_backend22__omp_extract_base_ptrB7v180000IPiEEDaT_(ptr noundef %p) #8 comdat {
entry:
...
define internal void @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend29__omp_parallel_for_simd_val_1B7v180000IPiliEET_S4_T0_RKT1_i_l101(i64 noundef %__n, ptr noundef %__first, ptr noundef nonnull align 4 dereferenceable(4) %__value) #10 {
entry:
  %__n.addr = alloca i64, align 8
  %__first.addr = alloca ptr, align 8
  %__value.addr = alloca ptr, align 8
...
; Function Attrs: alwaysinline norecurse nounwind uwtable
define internal void @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend29__omp_parallel_for_simd_val_1B7v180000IPiliEET_S4_T0_RKT1_i_l101.omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %__n, ptr noundef %__first, ptr noundef nonnull align 4 dereferenceable(4) %__value) #10 {
entry:
  ...
  %__n.casted = alloca i64, align 8
  store ptr %.global_tid., ptr %.global_tid..addr, align 8, !tbaa !7
  store ptr %.bound_tid., ptr %.bound_tid..addr, align 8, !tbaa !7
  store i64 %__n, ptr %__n.addr, align 8, !tbaa !16
  store ptr %__first, ptr %__first.addr, align 8, !tbaa !7
  store ptr %__value, ptr %__value.addr, align 8, !tbaa !7
  %0 = load ptr, ptr %__value.addr, align 8, !tbaa !7
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr %.capture_expr.) #11
  %1 = load i64, ptr %__n.addr, align 8, !tbaa !16
...
omp.precond.then:                                 ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.comb.lb) #11
  store i64 0, ptr %.omp.comb.lb, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.comb.ub) #11
  %4 = load i64, ptr %.capture_expr.2, align 8, !tbaa !16
  store i64 %4, ptr %.omp.comb.ub, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.stride) #11
  store i64 1, ptr %.omp.stride, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(i64 4, ptr %.omp.is_last) #11
  store i32 0, ptr %.omp.is_last, align 4, !tbaa !11
  call void @llvm.lifetime.start.p0(i64 8, ptr %__i4) #11
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %18 = load ptr, ptr %__first.addr, align 8, !tbaa !7, !llvm.access.group !18
  %19 = load ptr, ptr %tmp, align 8, !tbaa !7, !llvm.access.group !18
...
omp.loop.exit:                                    ; preds = %omp.inner.for.end
  ...
  %24 = load i32, ptr %.omp.is_last, align 4, !tbaa !11
  %25 = icmp ne i32 %24, 0
...
.omp.final.done:                                  ; preds = %.omp.final.then, %omp.loop.exit
  call void @llvm.lifetime.end.p0(i64 8, ptr %__i4) #11
  br label %omp.precond.end

omp.precond.end:                                  ; preds = %.omp.final.done, %entry
  call void @llvm.lifetime.end.p0(i64 4, ptr %.omp.is_last) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.omp.stride) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.omp.comb.ub) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.omp.comb.lb) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.capture_expr.2) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.capture_expr.) #11
...
; Function Attrs: alwaysinline norecurse nounwind uwtable
define internal void @__omp_offloading_16_63dbd8c8__ZNSt3__113__par_backend17__omp_gpu_backend29__omp_parallel_for_simd_val_1B7v180000IPiliEET_S4_T0_RKT1_i_l101.omp_outlined.omp_outlined(ptr noalias noundef %.global_tid., ptr noalias noundef %.bound_tid., i64 noundef %.previous.lb., i64 noundef %.previous.ub., i64 noundef %__n, ptr noundef %__first, ptr noundef nonnull align 4 dereferenceable(4) %__value) #10 {
entry:
  %.global_tid..addr = alloca ptr, align 8
  %.bound_tid..addr = alloca ptr, align 8
...
omp.precond.then:                                 ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.lb) #11
  store i64 0, ptr %.omp.lb, align 8, !tbaa !16
  call void @llvm.lifetime.start.p0(i64 8, ptr %.omp.ub) #11
  %4 = load i64, ptr %.capture_expr.2, align 8, !tbaa !16
...
omp.inner.for.body:                               ; preds = %omp.inner.for.cond
  ...
  %17 = load ptr, ptr %tmp, align 8, !tbaa !7, !llvm.access.group !22
  %18 = load i32, ptr %17, align 4, !tbaa !11, !llvm.access.group !22
  %19 = load ptr, ptr %__first.addr, align 8, !tbaa !7, !llvm.access.group !22
  %20 = load i64, ptr %__i4, align 8, !tbaa !16, !llvm.access.group !22
  %arrayidx = getelementptr inbounds i32, ptr %19, i64 %20
  store i32 %18, ptr %arrayidx, align 4, !tbaa !11, !llvm.access.group !22
...
.omp.final.done:                                  ; preds = %.omp.final.then, %omp.loop.exit
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr %.omp.is_last) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.omp.stride) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.omp.ub) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr %.omp.lb) #11
  br label %omp.precond.end
...
; Function Attrs: nounwind
declare !callback !25 void @__kmpc_fork_teams(ptr, i32, ptr, ...) #11

; Function Attrs: nocallback nofree nounwind willreturn memory(argmem: readwrite)
declare void @llvm.memcpy.p0.p0.i64(ptr noalias nocapture writeonly, ptr noalias nocapture readonly, i64, i1 immarg) #12

; Function Attrs: nounwind
declare i32 @__tgt_target_kernel(ptr, i64, i32, i32, ptr, ptr) #11
...
; Function Attrs: nounwind
declare void @__tgt_register_requires(i64) #11
