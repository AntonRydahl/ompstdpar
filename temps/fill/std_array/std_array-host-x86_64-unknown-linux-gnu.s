...
# %bb.0:                                # %entry
	...
	subq	$143165768, %rsp                # imm = 0x8888948
	.cfi_def_cfa_offset 143165824
	.cfi_offset %rbx, -56
	.cfi_offset %r12, -48
	.cfi_offset %r13, -40
	.cfi_offset %r14, -32
...
.LBB0_1:                                # %vector.body
	...
	movdqa	%xmm1, %xmm8
	psubd	%xmm0, %xmm8
	movdqu	%xmm7, 112(%rsp,%rax,4)
	movdqu	%xmm8, 128(%rsp,%rax,4)
	movdqa	%xmm2, %xmm7
	psubd	%xmm0, %xmm7
	movdqa	%xmm3, %xmm8
	psubd	%xmm0, %xmm8
	movdqu	%xmm7, 144(%rsp,%rax,4)
	movdqu	%xmm8, 160(%rsp,%rax,4)
	movdqa	%xmm4, %xmm7
	psubd	%xmm0, %xmm7
	movdqa	%xmm5, %xmm8
	psubd	%xmm0, %xmm8
	movdqu	%xmm7, 176(%rsp,%rax,4)
	movdqu	%xmm8, 192(%rsp,%rax,4)
	paddd	%xmm6, %xmm0
	addq	$24, %rax
...
.LBB0_4:                                # %for.body5
	...
	pxor	%xmm0, %xmm0
	movdqu	%xmm0, (%rbp)
	movq	$35791394, 144(%rsp)            # imm = 0x2222222
	movdqu	%xmm0, 40(%rbp)
	movdqu	%xmm0, 24(%rbp)
	movl	$0, 56(%rbp)
	movq	%r15, %rdi
...
.LBB0_6:                                # %_ZNSt3__14fillB7v180000IRKNS_9execution27parallel_unsequenced_policyEPiiS2_TnNS_9enable_ifIX21is_execution_policy_vIT2_EEiE4typeELi0EEEvOT_T0_SC_RKT1_.exit
                                        #   in Loop: Header=BB0_4 Depth=1
	movl	192(%rsp), %eax
	cmpl	12(%rsp), %eax
	jne	.LBB0_10
...
# %bb.9:                                # %for.cond.cleanup4
	xorl	%eax, %eax
	addq	$143165768, %rsp                # imm = 0x8888948
	.cfi_def_cfa_offset 56
	popq	%rbx
	.cfi_def_cfa_offset 48
	popq	%r12
